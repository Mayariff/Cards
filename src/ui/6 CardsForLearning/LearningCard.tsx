...
import CardQuestion from './6.1 CardСontent/CardQuestion';
import CardAnswer from './6.1 CardСontent/CardAnswer';
import {PackType} from "../../bll/reducers/packReducer";
import ButtonMenu from "./6.2 ButtonMenuForCard/ButtonMenu";
